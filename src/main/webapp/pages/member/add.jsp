...
<div class="weadmin-body">
    ...
    <form action="" method="post" class="layui-form"  id="addEmp">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="uname" required lay-verify="uname" value="">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">密码：</label>
            <div class="layui-input-inline">
                <input type="password" name="pwd" required lay-verify="pwd">
            </div>
        </div>
        <div class="layui-form-item">
        ...
        <div class="layui-form-item layui-form-text">
            ...
            <div class="layui-input-block">
                <textarea name="remark" required class="layui-textarea"  ></textarea></div>
        </div>
...
<script>
    layui.use(['form','upload','jquery'],function() {
        ...
        $.getJSON("${pageContext.request.contextPath}/info.do", function (data) {
            ...
            $.each(data.sta,function (i, s) {
                option += '<option value="' +s.sta_id + '">' +s.sta_name+ '</option>'
            });
            $('#state').html(option);
            //必须重新渲染
            form.render('select');
